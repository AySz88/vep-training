...
sizeChoices = 10 * 2.^[0 1 2 3]; % sigma in arcmin at fovea
separation = 3; % Number of sigma between the centers of the gabors
...
%         sizes = sizes' .* pdist2(gaborCenters, presCenter).^0.7;
        ...
        sizes = magCoordScalesPx(coordIndexes); % FIXME this is the number of pixels for a cycle, not the whole texture
