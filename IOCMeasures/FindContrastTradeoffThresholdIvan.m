function [ ts, sds, Ss ] = FindContrastTradeoffThresholdIvan( trialName )
%FINDCONTRASTTRADEOFFTHRESHOLDIVAN
%  This version runs ONLY the 25% coherence condition, otherwise like Oksana's version
...
%                 graphs and folder names
    ...
    psychassert(isempty(dir('*.mat')), ...
        'FindContrastTOThresholdIvan:MATFilesInFolder', ...
    ...
    psychassert(ischar(trialName), ...
        'FindContrastTOThresholdIvan:badParameter', ...
