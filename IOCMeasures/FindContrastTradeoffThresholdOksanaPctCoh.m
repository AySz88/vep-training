function [ ts, sds, Ss ] = FindContrastTradeoffThresholdOksanaPctCoh( trialName )
%FINDCONTRASTTRADEOFFTHRESHOLDOKSANAPCTCOH TODO Summary of this function
...
%                 graphs and folder names
    ...
    variables = struct(...
        ...
        ...%'scaleFactor', {1.0, 1/sqrt(2.0), sqrt(2.0), 1.0, 1.0}, ...
        ...'sigDots', num2cell(E.P.sigDots .* [1.0, 1.0, 1.0, 0.5, 2.0])...
        );
